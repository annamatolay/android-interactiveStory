...
/**
 * Define the story class, what have a Page array field
 * (this contains only 7 pages now)
 * Each story element have a page, what have an image index, a text and two choices with their text and next page index.
 * (for usage look the StoryActivity)
 */
public class Story {
    private Page[] mPages;
    ...
    public Page getPage(Integer index) {
        return mPages[index];
    }
}
